...
- Verified data integrity of more than 4 million records in the data warehouse using `Python`, `R`, and `SQL`.
...
- [`r ico("link")`](https://anthonyyoskovich.com/) I occasionally blog and tinker around on my website built with `R Markdown` and hosted on `Netlify`.
...
<a href="google.com" class="no-print"> Here is a link. </a>
...
- Recipient of the Statistics Scholarship (Winter 2020)
